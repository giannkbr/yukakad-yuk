...
<body>
    ...
    <div class="background"
        style="background-image: linear-gradient(rgba(46,27,23,0.7),rgba(46,27,23,0.7)), url(<?= base_url('assets/demo/bunga/') ?>image/bg3.jpg);">
    </div>
    <div class="content" id="pembungkus- konten">
        ...
        <section class="" id="hero"
            ...
            <div class="hero text-center" data-aos="fade-right" data-aos-duration="1200">
                ...
                <div class="nama-mempelai mt-2">
                    <h2><?= $undangan['mempelai_wanita'] ?></h2>
                    <h2>&</h2>
                    <h2><?= $undangan['mempelai_pria'] ?></h2>
                </div>
                <div class="tanggal">
                    <p class="mt-4 mb-0 fs-5">pada hari <br>
                        <?= strftime("%A, %d %B %Y", strtotime($undangan['tanggal_akad'])) ?></p>
        ...
        <!-- Profile Mempelai -->
        <section class="" id="profile-mempelai"
            style="background-image: url(<?= base_url('assets/demo/bunga/') ?>image/bg2.jpg); background-size: cover;">
            <div class="profile-mempelai text-center" data-aos="fade-left" data-aos-duration="1200">
                <img class="bunga-atas" src="<?= base_url('assets/demo/bunga/') ?>element/bunga.png" width="400"
                    height="142">
                <div class="card-profile">
                    ...
                    <div class="row position-relative justify-content-center ">
                        <div class="wanita col-46-mod p-0 ">
                            <img class="lingkaran-bunga-wanita1"
                                src="<?= base_url('assets/demo/bunga/') ?>element/lingkaran_foto.png"
                                alt="Lingkaran Bunga">
                            <img class="lingkaran-bunga-wanita2"
                                src="<?= base_url('assets/demo/bunga/') ?>element/lingkaran_foto.png"
                                alt="Lingkaran Bunga">
                            <img src="<?= base_url('assets/demo/bunga/') ?>/image/Foto Wanita.svg" alt="Foto Wanita"
                                width="100" height="100" class="foto-wanita">
                            <h5 class=""><?= $undangan['mempelai_wanita'] ?></h5>
                            <p class="mb-2 fw-bold" style="font-size: 14;">Putri Dari</p>
                            <p style="font-style: italic;">Bpk <?= $undangan['bapak_mempelaiwanita'] ?></p>
                            <p style="font-style: italic;">Ibu <?= $undangan['ibu_mempelaiwanita'] ?></p>
                            <hr class="ms-2">
                        </div>
                        <img class="cincin position-absolute" src="<?= base_url('assets/demo/bunga/') ?>/icon/rings.svg"
                            alt="Cincin" width="54" height="40">
                        <div class="pria col-46-mod p-0 ">
                            <img class="lingkaran-bunga-pria1"
                                src="<?= base_url('assets/demo/bunga/') ?>/element/lingkaran_foto.png"
                                alt="Lingkaran Bunga">
                            <img class="lingkaran-bunga-pria2"
                                src="<?= base_url('assets/demo/bunga/') ?>/element/lingkaran_foto.png"
                                alt="Lingkaran Bunga">
                            <img src="<?= base_url('assets/demo/bunga/') ?>/image/Foto Pria.svg" alt="Foto pria"
                                width="100" height="100" class="foto-pria">
                            <h5 class=""><?= $undangan['mempelai_pria'] ?></h5>
                            <p class="mb-2" style="font-size: 14;font-weight: bold;">Putra Dari</p>
                            <p style="font-style: italic;">Bpk <?= $undangan['bapak_mempelaipria'] ?></p>
                            <p style="font-style: italic;">Ibu <?= $undangan['ibu_mempelaipria'] ?></p>
                            <hr class="me-2">
                        </div>
                    </div>
                ...
                <img class="bunga-bawah" src="<?= base_url('assets/demo/bunga/') ?>/element/bunga.png" width="400"
                    height="142">
            </div>
        </section>
        ...
        <section class="align-items-start" id="jadwal" style="background: #F2F2F2;">
            <div class="jadwal text-center d-flex flex-column align-items-center justify-content-start my-4"
                ...
                <div class="akad card-jadwal">
                    <div class="judul">
                        ...
                        <img class="" src="<?= base_url('assets/demo/bunga/') ?>/element/hiasan-judul.png" alt="hiasan"
                            width="80" height="28.16">
                    </div>
                    <div class="row justify-content-end mx-3 mb-3">
                        <div class="col tanggal me-3 p-0">
                            <img class="mb-3" src="<?= base_url('assets/demo/bunga/') ?>icon/calendar.svg"
                                alt="calender" width="50" height="50">
                            <p><?= strftime("%A, %d %B %Y", strtotime($undangan['tanggal_akad'])) ?></p>
                        </div>
                        <div class="col jam p-0">
                            <img class="mt-2 mb-2" src="<?= base_url('assets/demo/bunga/') ?>icon/clock.svg"
                                alt="calender" width="50" height="50">
                ...
                <div class="akad card-jadwal">
                    <div class="judul">
                        <div class="judul d-flex align-items-center justify-content-center">
                            <img class="me-2" src="<?= base_url('assets/demo/bunga/') ?>/icon/countdownsvg.svg"
                                alt="countdown" width="25" height="25">
        ...
        <!-- Lokasi Acara -->
        <section class="align-items-start" id="lokasi-acara"
            style="background-image: url(<?= base_url('assets/demo/bunga/') ?>/image/bg2.jpg); background-size: cover;">
            <div class="lokasi-acara d-flex flex-column align-items-center justify-content-start mt-4"
                data-aos="fade-left" data-aos-duration="1200">
                <div class="judul text-center">
                    <h1 class="mb-2 fs-3">Lokasi Acara</h1>
                    <img class="mb-2" src="<?= base_url('assets/demo/bunga/') ?>/icon/location.svg" alt="lokasi-icon"
                        width="40" height="40">
                </div>
                <div class="alamat">
                    ...
                    <form action="#">
                        ...
                        <div class="input-group input-group-sm mb-0">
                            <input type="text" class="form-control py-0" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-sm" name="nama-lengkap" id="nama-lengkap"
                                placeholder="Nama lengkap">
                        </div>
                        <label for="hubungan" class="text-dark fs-7">Hubungan dengan mempelai</label>
                        <div class="input-group input-group-sm mb-0">
                            <input type="text" class="form-control py-0" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-sm" name="hubungan" id="hubungan"
                        ...
                        <div class="pilihan d-flex flex-wrap justify-content-between">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="kehadiran" id="tidak_tentu"
                                    value="tidak tentu">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="kehadiran" id="tidak_hadir"
                                    value="tidak hadir">
                        ...
                        <div class="text-center mt-2">
                            <button type="submit" class="btn btn-sm btn-primary"
                                style="border-radius: 5px;">Konfirmasi</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="bungkus-foto mb-3 bg-light">
                        ...
                        <div thumbsSlider="" class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <<img width="50px"
                                        src="<?= base_url('assets/user/img/foto/'.$foto_preweeding['foto']) ?>" />
                                </div>
                                <?php } ?>
        ...
        <!-- Cerita Cinta -->
        <section class="align-items-start position-relative" id="cerita-cinta"
            style="background-image: url(<?= base_url('assets/demo/bunga/') ?>/image/bg2.jpg); background-size: cover;">
            <div class="line"></div>
            <div class="cerita-cinta position-relative">
                ...
                <div class="kumpulan-cerita">
                    <div class="cerita">
                        <a href=""><img src="<?= base_url('assets/demo/bunga/') ?>/image/Foto Pria.svg" alt="foto pria"
                    ...
                    <div class="cerita">
                        <a href=""><img src="<?= base_url('assets/demo/bunga/') ?>/image/Foto Wanita.svg"
                                alt="foto pria" width="40" height="40"></a>
                ...
                <div class="text-start px-4">
                    ...
                    <div class="input-group input-group-sm mt-3">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-sm" name="nominal-kado" id="nominal-kado"
                            placeholder=" Masukan Nominal Kado">
                    </div>
        ...
        <!-- Do'a dan Ucapan -->
        <section class="align-items-start" id="doa-ucapan"
            style="background-image: url(<?= base_url('assets/demo/bunga/') ?>/image/bg2.jpg); background-size: cover;">
            <div class="doa-ucapan">
                <div class="judul text-center my-4">
                    <h1 class="fs-3">Do'a & Ucapan</h1>
                    <img src="<?= base_url('assets/demo/bunga/') ?>/icon/pesan.svg" alt="icon pesan" width="30"
                        height="30">
                </div>
                <div class="kirim-pesan p-3">
                    <form action="">
                        ...
                        <div class="input-group input-group-sm mb-0">
                            <input type="text" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-sm" name="Nama" id="Nama"
                                placeholder="Masukan Nama Anda">
                        </div>
                        <label for="pesan" class="text-dark fs-6">pesan</label>
                        <div class="input-group input-group-sm mb-0">
                            <textarea class="form-control" aria-label="With textarea" name="pesan" id="pesan" cols="30"
                ...
                <div class="card-pesan text-dark my-2 p-2">
                    <div class="pengirim">
                        <img class="rounded-circle" src="<?= base_url('assets/demo/bunga/') ?>/image/avatar1.svg"
                                ...
                                <div class="card-pesan text-dark p-2">
                                    <div class="pengirim">
                                        <img class="rounded-circle"
                                            src="<?= base_url('assets/demo/bunga/') ?>/image/avatar1.svg" alt="Avatar"
                                            width="25" height="25">
                                        <h4 class="ms-2">Nama Pengirim</h4>
                                    </div>
                                    <div class="waktu-dikirim">
